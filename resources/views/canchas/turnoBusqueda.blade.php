...
<div class="container">
    <div class="row">
    	...
    	<div class="col-md-12 col-sm-12 col-xs-12">
	        ...
	        <div class="acomodar col-md-10 col-sm-10 col-xs-10" style="margin:0;">
				<ol class="lista col-md-12 col-sm-12 col-xs-12">
					<?php $panel = 1 ?>
					@foreach($estab as $est)
						<div class="establec col-md-12 col-sm-12 col-xs-12">
							<div class="col-md-12 col-sm-12 col-xs-12" style="background-color:blue;">
								<div class="col-md-12 col-sm-12 col-xs-12" >
									<p class="nombreEstabl">{{$est[0]->nombre}}</p>
								</div>
								<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-11 col-sm-11 col-xs-11" style="float:right; ">
								<li class="recuadro">
												...
												<div class="panel">
					    							<div class="panel-heading" role="tab" id=<?php echo $panel?> style="padding-left:0px;">
												      <h4 class="panel-title">
												        <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href=<?php echo "#collapse".$panel?> aria-expanded="false" aria-controls=<?php echo "collapse".$panel?>>Ver Turnos
